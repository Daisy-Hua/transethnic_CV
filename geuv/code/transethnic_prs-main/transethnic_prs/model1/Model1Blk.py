...
class Model1Blk:
    ...
    #protected method, check shapes of A and b, return shape list of A, e.g.,[p1,...,pi,...,pk]
    ...
    def _set_x_and_y(self, xlist, y):
        ...
        for i in range(1, len(xlist)):
            ...
            if nx != nx_:
                raise ValueError('Number of rows do not match in xlist.')#sample number for each block ought to be the same
            px_list.append(px_)
